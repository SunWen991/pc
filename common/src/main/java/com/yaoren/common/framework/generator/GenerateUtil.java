package com.yaoren.common.framework.generator;
...
public class GenerateUtil {
    ...
    //需要替换自己的文件路径
    private final String bean_path = "/Users/Macx/IdeaProjects/eop-back/eop-core/src/main/java/com/eptison/domain/entity";

    private final String mapper_path = "/Users/Macx/IdeaProjects/eop-back/eop-core/src/main/java/com/eptison/mapper";

    private final String xml_path = "/Users/Macx/IdeaProjects/eop-back/eop-core/src/main/java/com/eptison/mapper";

    private final String bean_package = "com.eptison" + ".entity";

    private final String mapper_package = "com.eptison" + ".mapper";


    private final String driverName = "com.mysql.jdbc.Driver";

    private final String user = "eop";

    private final String password = "eop";

    private final String url = "jdbc:mysql://192.168.30.207:3306/eop?allowMultiQueries=true&autoReconnect=true&characterEncoding=utf8";
...
//         this.outputSqlMapperMethod(bw, columns, types);
    ...
    //---------------  select方法（匹配有值的字段）
        bw.write("\t<!-- 查询有匹配的值 -->");
        bw.newLine();
        bw.write("\t<select id=\"selectByParams\" resultMap=\""
        ...
        bw.write("\t<!-- 查询有匹配的值 -->");
        bw.newLine();
        bw.write("\t<select id=\"queryTotal\" resultType=\"" + "INTEGER" + "\">");
        bw.newLine();
        bw.write("\t\t SELECT");
        bw.newLine();
        bw.write("\t\t count(*)");
